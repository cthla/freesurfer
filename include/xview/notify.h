...
#ifdef POLL
#define notify_set_fd_func(nclient, func, poll_fd) ndet_set_fd_func(nclient, func, poll_fd, NTFY_FD)
#endif /* POLL */
 ...
 */
typedef enum notify_dump_type { NOTIFY_ALL = 0, NOTIFY_DETECT = 1, NOTIFY_DISPATCH = 2 } Notify_dump_type;
 ...
 * Argument types
 */
typedef enum notify_signal_mode { NOTIFY_SYNC = 0, NOTIFY_ASYNC = 1 } Notify_signal_mode;

typedef enum notify_event_type { NOTIFY_SAFE = 0, NOTIFY_IMMEDIATE = 1 } Notify_event_type;
...
//                 (Notify_client nclient, int pid, int *status, struct rusage *rusage));
// #else
// EXTERN_FUNCTION(Notify_value notify_default_wait3,
//                 (Notify_client nclient, int pid, union wait *status, struct rusage *rusage));
// #endif
...
EXTERN_FUNCTION(Notify_value notify_next_event_func,
                (Notify_client nclient, Notify_event event, Notify_arg arg, Notify_event_type when));
...
EXTERN_FUNCTION(
    ...
    (Notify_client nclient, Notify_func func, int which, struct itimerval *value, struct itimerval *ovalue));
...
EXTERN_FUNCTION(Notify_func notify_set_signal_func,
                (Notify_client nclient, Notify_func func, int sig, Notify_signal_mode mode));
...
EXTERN_FUNCTION(Notify_error notify_interpose_event_func,
                (Notify_client nclient, Notify_func func, Notify_event_type when));
...
EXTERN_FUNCTION(Notify_error notify_interpose_signal_func,
                (Notify_client nclient, Notify_func func, int signal, Notify_signal_mode mode));
...
EXTERN_FUNCTION(Notify_error notify_post_destroy,
                (Notify_client nclient, Destroy_status status, Notify_event_type type));
EXTERN_FUNCTION(Notify_error notify_post_event,
                (Notify_client nclient, Notify_event event, Notify_event_type when_hint));
