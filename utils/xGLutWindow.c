...
static char *ksErrorStrings[xGWin_knNumErrorCodes] = { "No error.",
...
xGWin_tErr xGWin_New(xGLutWindowRef *oppWindow, int inWidth, int inHeight, char *isTitle)
{
  ...
  // check our params.
  if (NULL == isTitle || inWidth < 0 || inHeight < 0)
  {
...
error:
  ...
  DebugPrint(("Error %d in xGWin_New: %s", eResult, xGWin_GetErrorString(eResult)));
...
error:
  ...
  DebugPrint(("Error %d in xGWin_Delete: %s", eResult, xGWin_GetErrorString(eResult)));
...
error:
  ...
  DebugPrint(("Error %d in xGWin_SetWindowTitle: %s", eResult, xGWin_GetErrorString(eResult)));
...
error:
  ...
  DebugPrint(("Error %d in xGWin_SetEventHandlerFunc: %s", eResult, xGWin_GetErrorString(eResult)));
...
error:
  ...
  DebugPrint(("Error %d in xGWin_ActivateIdleEvents: %s", eResult, xGWin_GetErrorString(eResult)));
...
error:
  ...
  DebugPrint(("Error %d in xGWin_ActivatePassiveMotionEvents: %s", eResult, xGWin_GetErrorString(eResult)));
