...
COLOR_TABLE *CTABreadASCII2(const char *fname, int checkDuplicateNames)
{
  ...
  if (!fp)
  {
    ErrorReturn(NULL, (ERROR_NOFILE, "CTABreadASCII(%s): could not open file", fname));
  }
  ...
  if (ct == NULL)
  {
    ErrorReturn(NULL, (ERROR_NO_MEMORY, "CTABreadASCII(%s): could not allocate table", fname));
  }
  ...
  while ((cp = fgets(line, STRLEN, fp)) != NULL)
  {
    ...
    if (nscan != 7)
    {
      tt = -1; // set tissue type to -1 if not there
    }
    if (nscan >= 6)
    {
...
COLOR_TABLE *CTABdeepCopy(COLOR_TABLE *ct)
{
  ...
  if (copy == NULL)
    ErrorReturn(NULL, (ERROR_NO_MEMORY, "CTABdeepCopy: could not allocate table"));
  ...
  if (ct->ctabTissueType)
    copy->ctabTissueType = CTABdeepCopy(ct->ctabTissueType);
...
int CTABwriteIntoBinary(COLOR_TABLE *ct, FILE *fp)
{
  ...
  if (NULL == ct)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABwriteIntoBinary: ct was NULL"));
  if (NULL == fp)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABwriteIntoBinary: fp was NULL"));
...
COLOR_TABLE *CTABreadFromBinaryV1(FILE *fp, int nentries)
{
  ...
  if (nentries < 0)
    ErrorReturn(NULL, (ERROR_BADPARM, "CTABreadFromBinaryV1: nentries was %d", nentries));

  /* Allocate our table. */
  ct = (COLOR_TABLE *)calloc(1, sizeof(COLOR_TABLE));
  if (ct == NULL)
    ErrorReturn(NULL, (ERROR_NO_MEMORY, "CTABreadFromBinaryV1: could not allocate table"));
  ...
  {
    ErrorReturn(NULL, (ERROR_BADFILE, "CTABreadFromBinaryV1: could not read parameter(s)"));
  }
...
int CTABwriteIntoBinaryV1(COLOR_TABLE *ct, FILE *fp)
{
  ...
  if (NULL == ct)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABwriteIntoBinaryV1: ct was NULL"));
  if (NULL == fp)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABwriteIntoBinaryV1: fp was NULL"));
...
COLOR_TABLE *CTABreadFromBinaryV2(FILE *fp)
{
  ...
  if (nentries < 0)
    ErrorReturn(NULL, (ERROR_BADFILE, "CTABreadFromBinaryV2: nentries was %d", nentries));

  /* Allocate our table. */
  ct = (COLOR_TABLE *)calloc(1, sizeof(COLOR_TABLE));
  if (ct == NULL)
    ErrorReturn(NULL, (ERROR_NO_MEMORY, "CTABreadFromBinaryV2: could not allocate table"));
...
int CTABwriteIntoBinaryV2(COLOR_TABLE *ct, FILE *fp)
{
  ...
  if (NULL == ct)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABwriteIntoBinaryV2: ct was NULL"));
  if (NULL == fp)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABwriteIntoBinaryV2: fp was NULL"));
...
int CTABcopyFileName(COLOR_TABLE *ct, char *name, size_t name_len)
{
  ...
  if (NULL == name)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABcopyName: output parameter was NULL"));
...
int CTABgetNumberOfValidEntries(COLOR_TABLE *ct, int *num)
{
  ...
  if (NULL == ct)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABgetNumberOfValidEntries: ct was NULL"));
  if (NULL == num)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABgetNumberOfValidEntries: num was NULL"));
...
{
  if (NULL == ct)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABgetNumberOfTotalEntries: ct was NULL"));
  if (NULL == num)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABgetNumberOfTotalEntries: num was NULL"));
...
{
  if (NULL == ct)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABisEntryValid: ct was NULL"));
  if (index < 0 || index >= ct->nentries)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABisEntryValid: index %d was OOB", index));
  if (NULL == valid)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABisEntryValid: valid was NULL"));
...
{
  if (NULL == ct)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABrgbaAtIndexi: ct was NULL"));
  if (index < 0 || index >= ct->nentries)
...
{
  if (NULL == ct)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABrgbaAtIndexf: ct was NULL"));
  if (index < 0 || index >= ct->nentries)
...
int CTABannotationAtIndex(COLOR_TABLE *ct, int index, int *annot)
{
  ...
  if (NULL == ct)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABannotationAtIndex: ct was NULL"));
  if (index < 0 || index >= ct->nentries)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABannotationAtIndex: index %d was OOB", index));
  if (NULL == annot)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABannotationAtIndex: output parameter was NULL"));
...
int CTABfindAnnotation(COLOR_TABLE *ct, int annotation, int *index)
{
  ...
  if (NULL == ct)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABfindAnnotation: ct was NULL"));
  if (NULL == index)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABfindAnnotation: output parameter was NULL"));
...
int CTABfindRGBi(COLOR_TABLE *ct, int r, int g, int b, int *index)
{
  ...
  if (NULL == index)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABfindRGBi: output parameter was NULL"));
...
int CTABfindName(COLOR_TABLE *ct, const char *name, int *index)
{
  ...
  if (NULL == index)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABfindName: output parameter was NULL"));
...
int CTABwriteFileASCII(COLOR_TABLE *ct, const char *fname)
{
  ...
  if (NULL == ct)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABwriteFileASCII: ct was NULL"));
  if (NULL == fname)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABwriteFileASCII: fname was NULL"));
...
int CTABprintASCIItt(COLOR_TABLE *ct, FILE *fp)
{
  ...
  if (NULL == ct)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABprintASCIItt: ct was NULL"));
  if (NULL == fp)
    ErrorReturn(ERROR_BADPARM, (ERROR_BADPARM, "CTABprintASCIItt: fp was NULL"));
