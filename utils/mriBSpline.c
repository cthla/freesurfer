                        ...
                        * (-4177.0 / 32.0
                           + w
                                 * (2275.0 / 16.0
                                    + w
                                          * (-487.0 / 8.0
                                             + w * (-85.0 / 8.0 + w * (41.0 / 2.0 + w * (-5.0 + w * (-2.0 + w))))))))
                 / 1440.0;
    weights[3] = (310661.0 / 1792.0
                  - w
                        * (14219.0 / 64.0
                           + w
                                 * (-199.0 / 8.0
                 ...
                 * (-246.0
                    + w
                          * (472.0
                             + w
                                   * (-504.0
                                      + w * (308.0 + w * (-84.0 + w * (-56.0 / 3.0 + w * (24.0 + w * (-8.0 + w)))))))))
          / 40320.0;
    weights[2]
        = (3652.0 / 9.0
           - w
                 ...
                 * (123.0 / 2.0
                    + w
                          * (118.0
                             + w
                                   * (126.0
                                      + w * (77.0 + w * (21.0 + w * (-14.0 / 3.0 + w * (-6.0 + w * (-2.0 + w)))))))))
          / 10080.0;
    weights[9] = w2 * w2;
